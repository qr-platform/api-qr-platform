...
exports.postCodesBulk = postCodesBulk;
/**
 ...
 */
const postCodesGenetateCanvasPng = (options) => {
    return (options?.client ?? client_gen_1.client).post({
        security: [
            {
                scheme: 'bearer',
