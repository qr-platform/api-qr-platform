 ...
 */
export declare const postCodesBulk: <ThrowOnError extends boolean = false>(options?: Options<PostCodesBulkData, ThrowOnError>) => import("./client").RequestResult<PostCodesBulkResponses, PostCodesBulkErrors, ThrowOnError, "fields">;
/**
 ...
 */
export declare const postCodesGenetateCanvasPng: <ThrowOnError extends boolean = false>(options?: Options<PostCodesGenetateCanvasPngData, ThrowOnError>) => import("./client").RequestResult<PostCodesGenetateCanvasPngResponses, PostCodesGenetateCanvasPngErrors, ThrowOnError, "fields">;
/**
 ...
 */
export declare const getScansByScanId: <ThrowOnError extends boolean = false>(options: Options<GetScansByScanIdData, ThrowOnError>) => import("./client").RequestResult<GetScansByScanIdResponses, GetScansByScanIdErrors, ThrowOnError, "fields">;
/**
 * List all templates
