 ...
 */
const postCodesGenetateCanvasPngOptions = (options) => {
    return (0, react_query_1.queryOptions)({
        queryFn: async ({ queryKey, signal }) => {
 ...
 * Generates a pixel-perfect PNG for a QR Code using Puppeteer + Canvas rendering, then optimizes it with sharp.
 */
const postCodesGenetateCanvasPngMutation = (options) => {
    const mutationOptions = {
        mutationFn: async (localOptions) => {
            const { data } = await (0, sdk_gen_1.postCodesGenetateCanvasPng)({
                ...options,
