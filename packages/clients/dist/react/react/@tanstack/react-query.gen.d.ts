 ...
 */
export declare const getSettingsOptions: (options?: Options<GetSettingsData>) => import("@tanstack/react-query").OmitKeyof<import("@tanstack/react-query").UseQueryOptions<import("../types.gen").SettingsWithCategoryResponse, Error, import("../types.gen").SettingsWithCategoryResponse, [Pick<Options<GetSettingsData>, "query" | "body" | "headers" | "path" | "baseUrl"> & {
    _id: string;
    _infinite?: boolean;
}]>, "queryFn"> & {
    queryFn?: import("@tanstack/react-query").QueryFunction<import("../types.gen").SettingsWithCategoryResponse, [Pick<Options<GetSettingsData>, "query" | "body" | "headers" | "path" | "baseUrl"> & {
        _id: string;
        _infinite?: boolean;
    }], never> | undefined;
} & {
    queryKey: [Pick<Options<GetSettingsData>, "query" | "body" | "headers" | "path" | "baseUrl"> & {
        ...
        [dataTagSymbol]: import("../types.gen").SettingsWithCategoryResponse;
        [dataTagErrorSymbol]: Error;
    };
};
 ...
 */
export declare const getWorkspacesByWorkspaceIdSettingsOptions: (options: Options<GetWorkspacesByWorkspaceIdSettingsData>) => import("@tanstack/react-query").OmitKeyof<import("@tanstack/react-query").UseQueryOptions<import("../types.gen").SettingsWithCategoryResponse, Error, import("../types.gen").SettingsWithCategoryResponse, [Pick<Options<GetWorkspacesByWorkspaceIdSettingsData>, "query" | "body" | "headers" | "path" | "baseUrl"> & {
    _id: string;
    _infinite?: boolean;
}]>, "queryFn"> & {
    queryFn?: import("@tanstack/react-query").QueryFunction<import("../types.gen").SettingsWithCategoryResponse, [Pick<Options<GetWorkspacesByWorkspaceIdSettingsData>, "query" | "body" | "headers" | "path" | "baseUrl"> & {
        _id: string;
        _infinite?: boolean;
    }], never> | undefined;
} & {
...
export declare const postCodesGenetateCanvasPngQueryKey: (options?: Options<PostCodesGenetateCanvasPngData>) => [Pick<Options<PostCodesGenetateCanvasPngData>, "query" | "body" | "headers" | "path" | "baseUrl"> & {
    _id: string;
    _infinite?: boolean;
}];
/**
 * Generate QR Code PNG via Canvas
 * Generates a pixel-perfect PNG for a QR Code using Puppeteer + Canvas rendering, then optimizes it with sharp.
 */
export declare const postCodesGenetateCanvasPngOptions: (options?: Options<PostCodesGenetateCanvasPngData>) => import("@tanstack/react-query").OmitKeyof<import("@tanstack/react-query").UseQueryOptions<Blob | File, Error, Blob | File, [Pick<Options<PostCodesGenetateCanvasPngData>, "query" | "body" | "headers" | "path" | "baseUrl"> & {
    _id: string;
    _infinite?: boolean;
}]>, "queryFn"> & {
    queryFn?: import("@tanstack/react-query").QueryFunction<Blob | File, [Pick<Options<PostCodesGenetateCanvasPngData>, "query" | "body" | "headers" | "path" | "baseUrl"> & {
        _id: string;
        _infinite?: boolean;
    }], never> | undefined;
} & {
    queryKey: [Pick<Options<PostCodesGenetateCanvasPngData>, "query" | "body" | "headers" | "path" | "baseUrl"> & {
        _id: string;
        _infinite?: boolean;
    }] & {
 ...
 * Generates a pixel-perfect PNG for a QR Code using Puppeteer + Canvas rendering, then optimizes it with sharp.
 */
export declare const postCodesGenetateCanvasPngMutation: (options?: Partial<Options<PostCodesGenetateCanvasPngData>>) => UseMutationOptions<PostCodesGenetateCanvasPngResponse, PostCodesGenetateCanvasPngError, Options<PostCodesGenetateCanvasPngData>>;
