...
export const postCodesGenetateCanvasPngQueryKey = (options?: Options<PostCodesGenetateCanvasPngData>) => createQueryKey('postCodesGenetateCanvasPng', options);
 ...
 */
export const postCodesGenetateCanvasPngOptions = (options?: Options<PostCodesGenetateCanvasPngData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
 ...
 * Generates a pixel-perfect PNG for a QR Code using Puppeteer + Canvas rendering, then optimizes it with sharp.
 */
export const postCodesGenetateCanvasPngMutation = (options?: Partial<Options<PostCodesGenetateCanvasPngData>>): UseMutationOptions<PostCodesGenetateCanvasPngResponse, PostCodesGenetateCanvasPngError, Options<PostCodesGenetateCanvasPngData>> => {
    const mutationOptions: UseMutationOptions<PostCodesGenetateCanvasPngResponse, PostCodesGenetateCanvasPngError, Options<PostCodesGenetateCanvasPngData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postCodesGenetateCanvasPng({
                ...options,
                ...localOptions,
...
export const getScansByScanIdQueryKey = (options: Options<GetScansByScanIdData>) => createQueryKey('getScansByScanId', options);

/**
 * Get scan by ID
 * Retrieves scan information by scanId in the same format as the scan-info dataType
 */
export const getScansByScanIdOptions = (options: Options<GetScansByScanIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
